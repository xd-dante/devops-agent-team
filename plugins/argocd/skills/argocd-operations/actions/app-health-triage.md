...
| Synced | Degraded | Manifests applied, workload failing. `HANDOFF → kubernetes-agent` for the pod-level cause |
| Synced | Progressing | A rollout is in flight or stuck. `HANDOFF → kubernetes-agent` |
